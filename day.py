...
class AdventOfCodeDay:
    ...
    def set_input_stream(self) -> None:
        ...
        response_stream = re.get(url=url, headers={'Cookie': self._session}, stream=True)
    ...
    def reset_input_stream(self) -> None:
        ...
        response_stream = re.get(url=self._cached_url, headers={'Cookie': self._session}, stream=True)
        response_stream.raise_for_status()
